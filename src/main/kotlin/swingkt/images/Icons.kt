...
object Icons {
    ...
    private val map = mutableMapOf<Pair<String, Int>, ImageIcon>()
     ...
     */
    fun loadIcon(file: String, size: Int = 16, baseColor: Color? = null, color: Color? = null): ImageIcon {
