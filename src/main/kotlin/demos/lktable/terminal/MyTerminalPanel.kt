package demos.lktable.terminal

import com.jediterm.terminal.TerminalMode
import com.jediterm.terminal.model.JediTerminal
import demos.lktable.LKIcons
...
import swingkt.layouts.flex.FlexJustifyContent
        ...
        flexcol(gap = 4, justifyContent = FlexJustifyContent.SPACE_BETWEEN) {
            ...
            flexcol(gap = 4) {
                bgButton = button(icon = LKIcons.formatColorFill(color = ICON_COLOR, size = ICON_SIZE)) {
                    ...
                    onAction {
                        JColorChooser.showDialog(this@MyTerminalPanel, "Choose Terminal Background Color",
                            BasicTerminalExample.bg
                        )?.let {
                ...
                fgButton = button(icon = LKIcons.formatColorText(color = ICON_COLOR, size = ICON_SIZE)) {
                    ...
                    onAction {
                        JColorChooser.showDialog(this@MyTerminalPanel, "Choose Terminal Foreground Color",
                            BasicTerminalExample.fg
                        )?.let {
